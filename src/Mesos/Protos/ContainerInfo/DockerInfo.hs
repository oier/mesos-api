...
module Mesos.Protos.ContainerInfo.DockerInfo (DockerInfo(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.ContainerInfo.DockerInfo.Network as Protos.ContainerInfo.DockerInfo (Network)
import qualified Mesos.Protos.ContainerInfo.DockerInfo.PortMapping as Protos.ContainerInfo.DockerInfo (PortMapping)
...
instance P'.ReflectDescriptor DockerInfo where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.ContainerInfo.DockerInfo\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"ContainerInfo\"], baseName = MName \"DockerInfo\"}, descFilePath = [\"Mesos\",\"Protos\",\"ContainerInfo\",\"DockerInfo.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.ContainerInfo.DockerInfo.image\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"ContainerInfo\",MName \"DockerInfo\"], baseName' = FName \"image\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 9}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.ContainerInfo.DockerInfo.network\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"ContainerInfo\",MName \"DockerInfo\"], baseName' = FName \"network\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 16}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 14}, typeName = Just (ProtoName {protobufName = FIName \".mesos.ContainerInfo.DockerInfo.Network\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"ContainerInfo\",MName \"DockerInfo\"], baseName = MName \"Network\"}), hsRawDefault = Just \"HOST\", hsDefault = Just (HsDef'Enum \"HOST\")},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.ContainerInfo.DockerInfo.port_mappings\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"ContainerInfo\",MName \"DockerInfo\"], baseName' = FName \"port_mappings\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 26}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = True, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.ContainerInfo.DockerInfo.PortMapping\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"ContainerInfo\",MName \"DockerInfo\"], baseName = MName \"PortMapping\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.ContainerInfo.DockerInfo.privileged\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"ContainerInfo\",MName \"DockerInfo\"], baseName' = FName \"privileged\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 4}, wireTag = WireTag {getWireTag = 32}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 8}, typeName = Nothing, hsRawDefault = Just \"false\", hsDefault = Just (HsDef'Bool False)},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.ContainerInfo.DockerInfo.parameters\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"ContainerInfo\",MName \"DockerInfo\"], baseName' = FName \"parameters\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 5}, wireTag = WireTag {getWireTag = 42}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = True, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Parameter\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"Parameter\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.ContainerInfo.DockerInfo.force_pull_image\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"ContainerInfo\",MName \"DockerInfo\"], baseName' = FName \"force_pull_image\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 6}, wireTag = WireTag {getWireTag = 48}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 8}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.ContainerInfo.DockerInfo.volume_driver\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"ContainerInfo\",MName \"DockerInfo\"], baseName' = FName \"volume_driver\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 7}, wireTag = WireTag {getWireTag = 58}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 9}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
