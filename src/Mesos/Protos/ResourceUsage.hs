...
module Mesos.Protos.ResourceUsage (ResourceUsage(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.ResourceUsage.Executor as Protos.ResourceUsage (Executor)
...
instance P'.ReflectDescriptor ResourceUsage where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.ResourceUsage\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"ResourceUsage\"}, descFilePath = [\"Mesos\",\"Protos\",\"ResourceUsage.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.ResourceUsage.executors\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"ResourceUsage\"], baseName' = FName \"executors\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = True, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.ResourceUsage.Executor\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"ResourceUsage\"], baseName = MName \"Executor\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.ResourceUsage.total\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"ResourceUsage\"], baseName' = FName \"total\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 18}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = True, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Resource\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"Resource\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
