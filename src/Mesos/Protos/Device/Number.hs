...
module Mesos.Protos.Device.Number (Number(..)) where
import Prelude ((+), (/))
...
instance P'.ReflectDescriptor Number where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.Device.Number\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Device\"], baseName = MName \"Number\"}, descFilePath = [\"Mesos\",\"Protos\",\"Device\",\"Number.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Device.Number.major_number\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Device\",MName \"Number\"], baseName' = FName \"major_number\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 4}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Device.Number.minor_number\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Device\",MName \"Number\"], baseName' = FName \"minor_number\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 16}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 4}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
