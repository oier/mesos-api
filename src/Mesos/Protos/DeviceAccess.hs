...
module Mesos.Protos.DeviceAccess (DeviceAccess(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.Device as Protos (Device)
import qualified Mesos.Protos.DeviceAccess.Access as Protos.DeviceAccess (Access)
...
instance P'.ReflectDescriptor DeviceAccess where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.DeviceAccess\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"DeviceAccess\"}, descFilePath = [\"Mesos\",\"Protos\",\"DeviceAccess.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.DeviceAccess.device\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"DeviceAccess\"], baseName' = FName \"device\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Device\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"Device\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.DeviceAccess.access\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"DeviceAccess\"], baseName' = FName \"access\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 18}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.DeviceAccess.Access\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"DeviceAccess\"], baseName = MName \"Access\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
