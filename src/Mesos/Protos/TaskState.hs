...
module Mesos.Protos.TaskState (TaskState(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum TaskState where
  ...
  toEnum = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Mesos.Protos.TaskState") . toMaybe'Enum
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Mesos.Protos.TaskState"
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Mesos.Protos.TaskState"
...
instance P'.ReflectEnum TaskState where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".mesos.TaskState") ["Mesos"] ["Protos"] "TaskState") ["Mesos", "Protos", "TaskState.hs"]
