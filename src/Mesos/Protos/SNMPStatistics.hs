...
module Mesos.Protos.SNMPStatistics (SNMPStatistics(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.IcmpStatistics as Protos (IcmpStatistics)
import qualified Mesos.Protos.IpStatistics as Protos (IpStatistics)
import qualified Mesos.Protos.TcpStatistics as Protos (TcpStatistics)
import qualified Mesos.Protos.UdpStatistics as Protos (UdpStatistics)
...
instance P'.ReflectDescriptor SNMPStatistics where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.SNMPStatistics\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"SNMPStatistics\"}, descFilePath = [\"Mesos\",\"Protos\",\"SNMPStatistics.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.SNMPStatistics.ip_stats\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"SNMPStatistics\"], baseName' = FName \"ip_stats\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.IpStatistics\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"IpStatistics\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.SNMPStatistics.icmp_stats\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"SNMPStatistics\"], baseName' = FName \"icmp_stats\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 18}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.IcmpStatistics\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"IcmpStatistics\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.SNMPStatistics.tcp_stats\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"SNMPStatistics\"], baseName' = FName \"tcp_stats\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 26}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.TcpStatistics\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"TcpStatistics\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.SNMPStatistics.udp_stats\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"SNMPStatistics\"], baseName' = FName \"udp_stats\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 4}, wireTag = WireTag {getWireTag = 34}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.UdpStatistics\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"UdpStatistics\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
