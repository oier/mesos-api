...
module Mesos.Protos.CommandInfo.URI (URI(..)) where
import Prelude ((+), (/))
...
instance P'.ReflectDescriptor URI where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.CommandInfo.URI\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"CommandInfo\"], baseName = MName \"URI\"}, descFilePath = [\"Mesos\",\"Protos\",\"CommandInfo\",\"URI.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CommandInfo.URI.value\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CommandInfo\",MName \"URI\"], baseName' = FName \"value\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 9}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CommandInfo.URI.executable\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CommandInfo\",MName \"URI\"], baseName' = FName \"executable\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 16}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 8}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CommandInfo.URI.extract\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CommandInfo\",MName \"URI\"], baseName' = FName \"extract\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 24}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 8}, typeName = Nothing, hsRawDefault = Just \"true\", hsDefault = Just (HsDef'Bool True)},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CommandInfo.URI.cache\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CommandInfo\",MName \"URI\"], baseName' = FName \"cache\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 4}, wireTag = WireTag {getWireTag = 32}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 8}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CommandInfo.URI.output_file\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CommandInfo\",MName \"URI\"], baseName' = FName \"output_file\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 5}, wireTag = WireTag {getWireTag = 42}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 9}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
