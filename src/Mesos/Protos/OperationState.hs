...
module Mesos.Protos.OperationState (OperationState(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum OperationState where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Mesos.Protos.OperationState") . toMaybe'Enum
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Mesos.Protos.OperationState"
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Mesos.Protos.OperationState"
...
instance P'.ReflectEnum OperationState where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".mesos.OperationState") ["Mesos"] ["Protos"] "OperationState")
      ["Mesos", "Protos", "OperationState.hs"]
