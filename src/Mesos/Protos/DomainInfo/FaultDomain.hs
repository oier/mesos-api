...
module Mesos.Protos.DomainInfo.FaultDomain (FaultDomain(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.DomainInfo.FaultDomain.RegionInfo as Protos.DomainInfo.FaultDomain (RegionInfo)
import qualified Mesos.Protos.DomainInfo.FaultDomain.ZoneInfo as Protos.DomainInfo.FaultDomain (ZoneInfo)
...
instance P'.ReflectDescriptor FaultDomain where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.DomainInfo.FaultDomain\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"DomainInfo\"], baseName = MName \"FaultDomain\"}, descFilePath = [\"Mesos\",\"Protos\",\"DomainInfo\",\"FaultDomain.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.DomainInfo.FaultDomain.region\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"DomainInfo\",MName \"FaultDomain\"], baseName' = FName \"region\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.DomainInfo.FaultDomain.RegionInfo\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"DomainInfo\",MName \"FaultDomain\"], baseName = MName \"RegionInfo\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.DomainInfo.FaultDomain.zone\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"DomainInfo\",MName \"FaultDomain\"], baseName' = FName \"zone\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 18}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.DomainInfo.FaultDomain.ZoneInfo\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"DomainInfo\",MName \"FaultDomain\"], baseName = MName \"ZoneInfo\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
