...
module Mesos.Protos.Volume.Source (Source(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.Secret as Protos (Secret)
import qualified Mesos.Protos.Volume.Source.DockerVolume as Protos.Volume.Source (DockerVolume)
import qualified Mesos.Protos.Volume.Source.HostPath as Protos.Volume.Source (HostPath)
import qualified Mesos.Protos.Volume.Source.SandboxPath as Protos.Volume.Source (SandboxPath)
import qualified Mesos.Protos.Volume.Source.Type as Protos.Volume.Source (Type)
...
instance P'.ReflectDescriptor Source where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.Volume.Source\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Volume\"], baseName = MName \"Source\"}, descFilePath = [\"Mesos\",\"Protos\",\"Volume\",\"Source.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Volume.Source.type\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Volume\",MName \"Source\"], baseName' = FName \"type'\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 14}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Volume.Source.Type\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Volume\",MName \"Source\"], baseName = MName \"Type\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Volume.Source.docker_volume\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Volume\",MName \"Source\"], baseName' = FName \"docker_volume\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 18}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Volume.Source.DockerVolume\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Volume\",MName \"Source\"], baseName = MName \"DockerVolume\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Volume.Source.host_path\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Volume\",MName \"Source\"], baseName' = FName \"host_path\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 5}, wireTag = WireTag {getWireTag = 42}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Volume.Source.HostPath\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Volume\",MName \"Source\"], baseName = MName \"HostPath\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Volume.Source.sandbox_path\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Volume\",MName \"Source\"], baseName' = FName \"sandbox_path\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 26}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Volume.Source.SandboxPath\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Volume\",MName \"Source\"], baseName = MName \"SandboxPath\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Volume.Source.secret\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Volume\",MName \"Source\"], baseName' = FName \"secret\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 4}, wireTag = WireTag {getWireTag = 34}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Secret\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"Secret\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
