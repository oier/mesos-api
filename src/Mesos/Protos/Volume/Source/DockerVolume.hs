...
module Mesos.Protos.Volume.Source.DockerVolume (DockerVolume(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.Parameters as Protos (Parameters)
...
instance P'.ReflectDescriptor DockerVolume where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.Volume.Source.DockerVolume\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Volume\",MName \"Source\"], baseName = MName \"DockerVolume\"}, descFilePath = [\"Mesos\",\"Protos\",\"Volume\",\"Source\",\"DockerVolume.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Volume.Source.DockerVolume.driver\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Volume\",MName \"Source\",MName \"DockerVolume\"], baseName' = FName \"driver\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 9}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Volume.Source.DockerVolume.name\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Volume\",MName \"Source\",MName \"DockerVolume\"], baseName' = FName \"name\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 18}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 9}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Volume.Source.DockerVolume.driver_options\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Volume\",MName \"Source\",MName \"DockerVolume\"], baseName' = FName \"driver_options\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 26}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Parameters\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"Parameters\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
