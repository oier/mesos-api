...
module Mesos.Protos.Volume.Source.HostPath (HostPath(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.MountPropagation as Protos (MountPropagation)
