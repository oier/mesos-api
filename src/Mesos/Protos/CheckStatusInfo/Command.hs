...
module Mesos.Protos.CheckStatusInfo.Command (Command(..)) where
import Prelude ((+), (/))
...
instance P'.ReflectDescriptor Command where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.CheckStatusInfo.Command\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"CheckStatusInfo\"], baseName = MName \"Command\"}, descFilePath = [\"Mesos\",\"Protos\",\"CheckStatusInfo\",\"Command.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CheckStatusInfo.Command.exit_code\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CheckStatusInfo\",MName \"Command\"], baseName' = FName \"exit_code\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 5}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
