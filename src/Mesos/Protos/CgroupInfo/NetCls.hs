...
module Mesos.Protos.CgroupInfo.NetCls (NetCls(..)) where
import Prelude ((+), (/))
...
instance P'.ReflectDescriptor NetCls where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.CgroupInfo.NetCls\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"CgroupInfo\"], baseName = MName \"NetCls\"}, descFilePath = [\"Mesos\",\"Protos\",\"CgroupInfo\",\"NetCls.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CgroupInfo.NetCls.classid\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CgroupInfo\",MName \"NetCls\"], baseName' = FName \"classid\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 13}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
