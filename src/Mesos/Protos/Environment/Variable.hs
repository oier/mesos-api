...
module Mesos.Protos.Environment.Variable (Variable(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.Environment.Variable.Type as Protos.Environment.Variable (Type)
