...
module Mesos.Protos.Event.Offers (Offers(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.Offer as Protos (Offer)
...
instance P'.ReflectDescriptor Offers where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.scheduler.Event.Offers\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Event\"], baseName = MName \"Offers\"}, descFilePath = [\"Mesos\",\"Protos\",\"Event\",\"Offers.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.scheduler.Event.Offers.offers\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Event\",MName \"Offers\"], baseName' = FName \"offers\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = True, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Offer\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"Offer\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
