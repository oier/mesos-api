...
module Mesos.Protos.Event.Subscribed (Subscribed(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.MasterInfo as Protos (MasterInfo)
