...
module Mesos.Protos.CgroupInfo (CgroupInfo(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.CgroupInfo.NetCls as Protos.CgroupInfo (NetCls)
...
instance P'.ReflectDescriptor CgroupInfo where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.CgroupInfo\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"CgroupInfo\"}, descFilePath = [\"Mesos\",\"Protos\",\"CgroupInfo.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CgroupInfo.net_cls\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CgroupInfo\"], baseName' = FName \"net_cls\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.CgroupInfo.NetCls\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"CgroupInfo\"], baseName = MName \"NetCls\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
