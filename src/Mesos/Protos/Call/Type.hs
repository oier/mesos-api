...
module Mesos.Protos.Call.Type (Type(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Type where
  ...
  toEnum = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Mesos.Protos.Call.Type") . toMaybe'Enum
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Mesos.Protos.Call.Type"
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Mesos.Protos.Call.Type"
...
instance P'.ReflectEnum Type where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".mesos.scheduler.Call.Type") ["Mesos"] ["Protos", "Call"] "Type")
      ["Mesos", "Protos", "Call", "Type.hs"]
