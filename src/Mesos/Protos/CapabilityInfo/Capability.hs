...
module Mesos.Protos.CapabilityInfo.Capability (Capability(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Capability where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Mesos.Protos.CapabilityInfo.Capability") .
      toMaybe'Enum
  succ UNKNOWN = CHOWN
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Mesos.Protos.CapabilityInfo.Capability"
  pred CHOWN = UNKNOWN
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Mesos.Protos.CapabilityInfo.Capability"
...
instance P'.ReflectEnum Capability where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".mesos.CapabilityInfo.Capability") ["Mesos"] ["Protos", "CapabilityInfo"] "Capability")
      ["Mesos", "Protos", "CapabilityInfo", "Capability.hs"]
