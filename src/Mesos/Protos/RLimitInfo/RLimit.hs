...
module Mesos.Protos.RLimitInfo.RLimit (RLimit(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.RLimitInfo.RLimit.Type as Protos.RLimitInfo.RLimit (Type)
...
instance P'.ReflectDescriptor RLimit where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.RLimitInfo.RLimit\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"RLimitInfo\"], baseName = MName \"RLimit\"}, descFilePath = [\"Mesos\",\"Protos\",\"RLimitInfo\",\"RLimit.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.RLimitInfo.RLimit.type\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"RLimitInfo\",MName \"RLimit\"], baseName' = FName \"type'\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 14}, typeName = Just (ProtoName {protobufName = FIName \".mesos.RLimitInfo.RLimit.Type\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"RLimitInfo\",MName \"RLimit\"], baseName = MName \"Type\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.RLimitInfo.RLimit.hard\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"RLimitInfo\",MName \"RLimit\"], baseName' = FName \"hard\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 16}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 4}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.RLimitInfo.RLimit.soft\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"RLimitInfo\",MName \"RLimit\"], baseName' = FName \"soft\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 24}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 4}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
