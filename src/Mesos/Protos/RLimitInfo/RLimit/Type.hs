...
module Mesos.Protos.RLimitInfo.RLimit.Type (Type(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Type where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Mesos.Protos.RLimitInfo.RLimit.Type") .
      toMaybe'Enum
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Mesos.Protos.RLimitInfo.RLimit.Type"
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Mesos.Protos.RLimitInfo.RLimit.Type"
...
instance P'.ReflectEnum Type where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".mesos.RLimitInfo.RLimit.Type") ["Mesos"] ["Protos", "RLimitInfo", "RLimit"] "Type")
      ["Mesos", "Protos", "RLimitInfo", "RLimit", "Type.hs"]
