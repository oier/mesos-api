...
module Mesos.Protos.NetworkInfo.PortMapping (PortMapping(..)) where
import Prelude ((+), (/))
...
instance P'.ReflectDescriptor PortMapping where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.NetworkInfo.PortMapping\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"NetworkInfo\"], baseName = MName \"PortMapping\"}, descFilePath = [\"Mesos\",\"Protos\",\"NetworkInfo\",\"PortMapping.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.NetworkInfo.PortMapping.host_port\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"NetworkInfo\",MName \"PortMapping\"], baseName' = FName \"host_port\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 13}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.NetworkInfo.PortMapping.container_port\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"NetworkInfo\",MName \"PortMapping\"], baseName' = FName \"container_port\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 16}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 13}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.NetworkInfo.PortMapping.protocol\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"NetworkInfo\",MName \"PortMapping\"], baseName' = FName \"protocol\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 26}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 9}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
