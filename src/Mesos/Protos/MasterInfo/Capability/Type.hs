...
module Mesos.Protos.MasterInfo.Capability.Type (Type(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Type where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Mesos.Protos.MasterInfo.Capability.Type") .
      toMaybe'Enum
  succ UNKNOWN = AGENT_UPDATE
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Mesos.Protos.MasterInfo.Capability.Type"
  pred AGENT_UPDATE = UNKNOWN
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Mesos.Protos.MasterInfo.Capability.Type"
...
instance P'.ReflectEnum Type where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".mesos.MasterInfo.Capability.Type") ["Mesos"] ["Protos", "MasterInfo", "Capability"] "Type")
      ["Mesos", "Protos", "MasterInfo", "Capability", "Type.hs"]
