...
module Mesos.Protos.Secret (Secret(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.Secret.Reference as Protos.Secret (Reference)
import qualified Mesos.Protos.Secret.Type as Protos.Secret (Type)
import qualified Mesos.Protos.Secret.Value as Protos.Secret (Value)
...
instance P'.ReflectDescriptor Secret where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.Secret\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"Secret\"}, descFilePath = [\"Mesos\",\"Protos\",\"Secret.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Secret.type\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Secret\"], baseName' = FName \"type'\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 14}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Secret.Type\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Secret\"], baseName = MName \"Type\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Secret.reference\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Secret\"], baseName' = FName \"reference\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 18}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Secret.Reference\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Secret\"], baseName = MName \"Reference\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Secret.value\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Secret\"], baseName' = FName \"value\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 26}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Secret.Value\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Secret\"], baseName = MName \"Value\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
