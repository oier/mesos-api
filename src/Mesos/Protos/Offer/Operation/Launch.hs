...
module Mesos.Protos.Offer.Operation.Launch (Launch(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.TaskInfo as Protos (TaskInfo)
...
instance P'.ReflectDescriptor Launch where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.Offer.Operation.Launch\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Offer\",MName \"Operation\"], baseName = MName \"Launch\"}, descFilePath = [\"Mesos\",\"Protos\",\"Offer\",\"Operation\",\"Launch.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Offer.Operation.Launch.task_infos\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Offer\",MName \"Operation\",MName \"Launch\"], baseName' = FName \"task_infos\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = True, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.TaskInfo\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"TaskInfo\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
