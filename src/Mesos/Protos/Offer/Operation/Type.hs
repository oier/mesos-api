...
module Mesos.Protos.Offer.Operation.Type (Type(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Type where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Mesos.Protos.Offer.Operation.Type") .
      toMaybe'Enum
  succ UNKNOWN = LAUNCH
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Mesos.Protos.Offer.Operation.Type"
  pred LAUNCH = UNKNOWN
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Mesos.Protos.Offer.Operation.Type"
...
instance P'.ReflectEnum Type where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".mesos.Offer.Operation.Type") ["Mesos"] ["Protos", "Offer", "Operation"] "Type")
      ["Mesos", "Protos", "Offer", "Operation", "Type.hs"]
