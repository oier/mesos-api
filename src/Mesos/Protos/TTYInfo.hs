...
module Mesos.Protos.TTYInfo (TTYInfo(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.TTYInfo.WindowSize as Protos.TTYInfo (WindowSize)
...
instance P'.ReflectDescriptor TTYInfo where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.TTYInfo\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"TTYInfo\"}, descFilePath = [\"Mesos\",\"Protos\",\"TTYInfo.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.TTYInfo.window_size\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"TTYInfo\"], baseName' = FName \"window_size\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.TTYInfo.WindowSize\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"TTYInfo\"], baseName = MName \"WindowSize\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
