...
module Mesos.Protos.CheckInfo (CheckInfo(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.CheckInfo.Command as Protos.CheckInfo (Command)
import qualified Mesos.Protos.CheckInfo.Http as Protos.CheckInfo (Http)
import qualified Mesos.Protos.CheckInfo.Tcp as Protos.CheckInfo (Tcp)
import qualified Mesos.Protos.CheckInfo.Type as Protos.CheckInfo (Type)
...
instance P'.ReflectDescriptor CheckInfo where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.CheckInfo\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"CheckInfo\"}, descFilePath = [\"Mesos\",\"Protos\",\"CheckInfo.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CheckInfo.type\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CheckInfo\"], baseName' = FName \"type'\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 14}, typeName = Just (ProtoName {protobufName = FIName \".mesos.CheckInfo.Type\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"CheckInfo\"], baseName = MName \"Type\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CheckInfo.command\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CheckInfo\"], baseName' = FName \"command\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 18}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.CheckInfo.Command\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"CheckInfo\"], baseName = MName \"Command\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CheckInfo.http\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CheckInfo\"], baseName' = FName \"http\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 26}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.CheckInfo.Http\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"CheckInfo\"], baseName = MName \"Http\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CheckInfo.tcp\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CheckInfo\"], baseName' = FName \"tcp\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 7}, wireTag = WireTag {getWireTag = 58}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.CheckInfo.Tcp\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"CheckInfo\"], baseName = MName \"Tcp\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CheckInfo.delay_seconds\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CheckInfo\"], baseName' = FName \"delay_seconds\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 4}, wireTag = WireTag {getWireTag = 33}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 1}, typeName = Nothing, hsRawDefault = Just \"15.0\", hsDefault = Just (HsDef'RealFloat (SRF'Rational (15 % 1)))},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CheckInfo.interval_seconds\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CheckInfo\"], baseName' = FName \"interval_seconds\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 5}, wireTag = WireTag {getWireTag = 41}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 1}, typeName = Nothing, hsRawDefault = Just \"10.0\", hsDefault = Just (HsDef'RealFloat (SRF'Rational (10 % 1)))},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.CheckInfo.timeout_seconds\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"CheckInfo\"], baseName' = FName \"timeout_seconds\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 6}, wireTag = WireTag {getWireTag = 49}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 1}, typeName = Nothing, hsRawDefault = Just \"20.0\", hsDefault = Just (HsDef'RealFloat (SRF'Rational (20 % 1)))}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
