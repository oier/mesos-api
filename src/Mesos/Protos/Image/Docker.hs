...
module Mesos.Protos.Image.Docker (Docker(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.Credential as Protos (Credential)
...
instance P'.ReflectDescriptor Docker where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.Image.Docker\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Image\"], baseName = MName \"Docker\"}, descFilePath = [\"Mesos\",\"Protos\",\"Image\",\"Docker.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Image.Docker.name\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Image\",MName \"Docker\"], baseName' = FName \"name\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 9}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Image.Docker.credential\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Image\",MName \"Docker\"], baseName' = FName \"credential\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 18}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Credential\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"Credential\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Image.Docker.config\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Image\",MName \"Docker\"], baseName' = FName \"config\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 26}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Secret\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"Secret\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
