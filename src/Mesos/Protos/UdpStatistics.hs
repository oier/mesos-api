...
module Mesos.Protos.UdpStatistics (UdpStatistics(..)) where
import Prelude ((+), (/))
...
instance P'.ReflectDescriptor UdpStatistics where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.UdpStatistics\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"UdpStatistics\"}, descFilePath = [\"Mesos\",\"Protos\",\"UdpStatistics.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.UdpStatistics.InDatagrams\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"UdpStatistics\"], baseName' = FName \"inDatagrams\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 3}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.UdpStatistics.NoPorts\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"UdpStatistics\"], baseName' = FName \"noPorts\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 16}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 3}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.UdpStatistics.InErrors\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"UdpStatistics\"], baseName' = FName \"inErrors\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 24}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 3}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.UdpStatistics.OutDatagrams\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"UdpStatistics\"], baseName' = FName \"outDatagrams\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 4}, wireTag = WireTag {getWireTag = 32}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 3}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.UdpStatistics.RcvbufErrors\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"UdpStatistics\"], baseName' = FName \"rcvbufErrors\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 5}, wireTag = WireTag {getWireTag = 40}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 3}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.UdpStatistics.SndbufErrors\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"UdpStatistics\"], baseName' = FName \"sndbufErrors\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 6}, wireTag = WireTag {getWireTag = 48}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 3}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.UdpStatistics.InCsumErrors\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"UdpStatistics\"], baseName' = FName \"inCsumErrors\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 7}, wireTag = WireTag {getWireTag = 56}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 3}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.UdpStatistics.IgnoredMulti\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"UdpStatistics\"], baseName' = FName \"ignoredMulti\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 8}, wireTag = WireTag {getWireTag = 64}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 3}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
