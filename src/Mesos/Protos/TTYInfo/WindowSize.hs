...
module Mesos.Protos.TTYInfo.WindowSize (WindowSize(..)) where
import Prelude ((+), (/))
...
instance P'.ReflectDescriptor WindowSize where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.TTYInfo.WindowSize\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"TTYInfo\"], baseName = MName \"WindowSize\"}, descFilePath = [\"Mesos\",\"Protos\",\"TTYInfo\",\"WindowSize.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.TTYInfo.WindowSize.rows\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"TTYInfo\",MName \"WindowSize\"], baseName' = FName \"rows\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 13}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.TTYInfo.WindowSize.columns\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"TTYInfo\",MName \"WindowSize\"], baseName' = FName \"columns\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 16}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 13}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
