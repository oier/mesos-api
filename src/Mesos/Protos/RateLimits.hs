...
module Mesos.Protos.RateLimits (RateLimits(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.RateLimit as Protos (RateLimit)
...
instance P'.ReflectDescriptor RateLimits where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.RateLimits\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"RateLimits\"}, descFilePath = [\"Mesos\",\"Protos\",\"RateLimits.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.RateLimits.limits\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"RateLimits\"], baseName' = FName \"limits\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = True, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.RateLimit\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"RateLimit\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.RateLimits.aggregate_default_qps\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"RateLimits\"], baseName' = FName \"aggregate_default_qps\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 17}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 1}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.RateLimits.aggregate_default_capacity\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"RateLimits\"], baseName' = FName \"aggregate_default_capacity\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 24}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 4}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
