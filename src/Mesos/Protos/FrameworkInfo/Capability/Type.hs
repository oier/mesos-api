...
module Mesos.Protos.FrameworkInfo.Capability.Type (Type(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Type where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Mesos.Protos.FrameworkInfo.Capability.Type") .
      toMaybe'Enum
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Mesos.Protos.FrameworkInfo.Capability.Type"
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Mesos.Protos.FrameworkInfo.Capability.Type"
...
instance P'.ReflectEnum Type where
  ...
  reflectEnumInfo _
   = P'.EnumInfo
      (P'.makePNF (P'.pack ".mesos.FrameworkInfo.Capability.Type") ["Mesos"] ["Protos", "FrameworkInfo", "Capability"] "Type")
      ["Mesos", "Protos", "FrameworkInfo", "Capability", "Type.hs"]
