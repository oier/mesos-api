...
module Mesos.Protos.FrameworkInfo.Capability (Capability(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.FrameworkInfo.Capability.Type as Protos.FrameworkInfo.Capability (Type)
...
instance P'.ReflectDescriptor Capability where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.FrameworkInfo.Capability\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"FrameworkInfo\"], baseName = MName \"Capability\"}, descFilePath = [\"Mesos\",\"Protos\",\"FrameworkInfo\",\"Capability.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.FrameworkInfo.Capability.type\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"FrameworkInfo\",MName \"Capability\"], baseName' = FName \"type'\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 14}, typeName = Just (ProtoName {protobufName = FIName \".mesos.FrameworkInfo.Capability.Type\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"FrameworkInfo\",MName \"Capability\"], baseName = MName \"Type\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
