...
module Mesos.Protos.Resource.DiskInfo (DiskInfo(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.Resource.DiskInfo.Persistence as Protos.Resource.DiskInfo (Persistence)
import qualified Mesos.Protos.Resource.DiskInfo.Source as Protos.Resource.DiskInfo (Source)
...
instance P'.ReflectDescriptor DiskInfo where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".mesos.Resource.DiskInfo\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Resource\"], baseName = MName \"DiskInfo\"}, descFilePath = [\"Mesos\",\"Protos\",\"Resource\",\"DiskInfo.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Resource.DiskInfo.persistence\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Resource\",MName \"DiskInfo\"], baseName' = FName \"persistence\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Resource.DiskInfo.Persistence\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Resource\",MName \"DiskInfo\"], baseName = MName \"Persistence\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Resource.DiskInfo.volume\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Resource\",MName \"DiskInfo\"], baseName' = FName \"volume\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 18}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Volume\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\"], baseName = MName \"Volume\"}), hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".mesos.Resource.DiskInfo.source\", haskellPrefix' = [MName \"Mesos\"], parentModule' = [MName \"Protos\",MName \"Resource\",MName \"DiskInfo\"], baseName' = FName \"source\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 3}, wireTag = WireTag {getWireTag = 26}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".mesos.Resource.DiskInfo.Source\", haskellPrefix = [MName \"Mesos\"], parentModule = [MName \"Protos\",MName \"Resource\",MName \"DiskInfo\"], baseName = MName \"Source\"}), hsRawDefault = Nothing, hsDefault = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
