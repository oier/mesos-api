...
module Mesos.Protos.NetworkInfo (NetworkInfo(..)) where
import Prelude ((+), (/))
...
import qualified Mesos.Protos.NetworkInfo.IPAddress as Protos.NetworkInfo (IPAddress)
import qualified Mesos.Protos.NetworkInfo.PortMapping as Protos.NetworkInfo (PortMapping)
